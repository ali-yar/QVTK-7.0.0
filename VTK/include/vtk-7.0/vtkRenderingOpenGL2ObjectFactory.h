...
private:
  vtkRenderingOpenGL2ObjectFactory(const vtkRenderingOpenGL2ObjectFactory&); // Not implemented
  void operator=(const vtkRenderingOpenGL2ObjectFactory&);      // Not implemented
};
